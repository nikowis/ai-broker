...
\subsection{Przewidywanie wartości spółek}

Do tematu można podejść na dwa sposoby:

\begin{itemize}
\item{przewidywanie konkretnych wartości}
\item{predyckja binarna wzrostu/spadku ceny}
\end{itemize}

Dużo bardziej przydatnym podejściem jest przewidywanie konkretnych wyników.
...
\section{Granie na giełdzie}
Przy graniu jedną z ważniejszych rzeczy do przewidzenia jest opłacalność każdej operacji. Ponieważ każda operacja jest obarczona prowizją domu maklerskiego, a zyski podatkiem kapitałowym. Mocno utrudnia to zadanie wykonywania transakcji o wysokiej częstotliwości.
