...
Na rysunku \ref{l_r_pct_change_last_30} można zaobserwować, iż zmiany w kursie prawie codziennie przekraczają $0,4\%$ w związku z czym transakcje przynoszące zysk można wykonywać regularnie. Ten wniosek potwierdza zasadność tej metody oceny modelu do predykcji. 
