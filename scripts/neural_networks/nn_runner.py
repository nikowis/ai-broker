...
def run(x, x_train, x_test, y_train_binary, y_test_binary, layers=LAYERS, epochs=EPOCHS,
    ...
    plot_helper.plot_result(y_test_binary, y_test_score, classes_count, history, main_title, file_name,
...
if __name__ == '__main__':
    ...
    df, x_standardized, x_train, x_test, y_train_binary, y_test_binary = data_helper.extract_data(df, HISTORY_DAYS)

    run(x_standardized, x_train, x_test, y_train_binary, y_test_binary)
