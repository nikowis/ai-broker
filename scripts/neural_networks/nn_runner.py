...
def run(df, x_standarized, x_train, x_test, y_train_binary, y_test_binary, layers=LAYERS, epochs=EPOCHS,
    ...
    plot_helper.plot_result(df, history, main_title, file_name, accuracy >= outstanding_treshold)
