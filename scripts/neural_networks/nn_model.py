...
def create_seq_model(hidden_layer_neuron_arr, activation=None, use_bias=True, class_count=3,
                     optimizer='adam',
                     loss='categorical_crossentropy', metric='categorical_accuracy', input_size=1):
    model = Sequential()
